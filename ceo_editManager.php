...
<div class="main">
    <div class="jumbotron p-5">
        <div class="container p-3">
            <h3 class="text-center p-4">Edit Data manager</h3>
            <form action="C_CEOmanagerEdit.php" method="post">
            <input type="hidden" name="id_manager" value="<?= $id; ?>">
                            <div class="form-row">
                                <div class="form-group col-md-8">
                                    <label class="custom-file-label" name="foto_manager" for="inputGroupFile01">Pilih Foto Profil</label>
                                </div>
                                <div class="form-group col-md-4">
                                    <input type="text" class="form-control" disabled value="<?= $id; ?>" placeholder="id" name="id" Required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-4">
